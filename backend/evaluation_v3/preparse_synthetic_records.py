...
CACHE_DIR = EVALUATION_V3_DIR / "cache"
OUTPUT_DIR = EVALUATION_V3_DIR / "output"
PARSED_DIR = CACHE_DIR / "parsed"
RECORD_INDEXES_DIR = CACHE_DIR / "retrieval" / "records"
DATASET_ROOT_DEFAULT = BACKEND_DIR / "synthetic_data" / "risk_dataset"
CATALOG_PATH_DEFAULT = CACHE_DIR / "synthetic_record_registry.csv"
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Pre-parse synthetic records and build retrieval indexes for evaluation_v3."
    )
    ...
    parser.add_argument("--run-name", default="synthetic_retrieval_prep")
...
def main() -> None:
    ...
    print(f"Saved synthetic record catalog to {args.catalog_path}", flush=True)
